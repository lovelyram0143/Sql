...
Select sum(maths) as totalmarks from students ;

select max(maths) as max_marks from students;

select min(maths) as min_marks from students;

select count(s_roll) as no_of_members from students;

select avg(maths) as average_of_maths,AVG(phy) as average_of_phy, AVG(che) average_of_che from students
--------
--clause 
------
...
-->where
select *from students where s_roll>=2;

-->group by
select s_name,AVG(maths) as maths,avg(phy) as phy ,AVG(che) as che from students group by s_name;

-->roder by 
select * from students order by s_roll desc;

-->top
select top(1)* from students order by s_roll desc; 

-->having
select s_name ,sum(maths)   as sum_of_maths from students group by s_name having sum(maths)>45;
...
-->=,<>,<,>
-->"="
select *from students where maths=40;
-->"<>" 'not equal to'
select *from students where maths<>40;
-->">"
select *from students where maths>40;
-->"<="
select *from students where maths<=50;
...
--AND
Select * from students where maths=30 and phy=60;

--OR
Select * from students where maths=30 OR phy=50;

--NOT
Select * from students where NOT maths=30;
...
--BETWEEN
Select *from students where s_roll between 1 and 3;

--NOT BETWEEN
Select *from students where s_roll not between 1 and 3;

--IN
Select *from students where s_roll in(1,4,5);

--NOT IN
Select *from students where s_roll not in(1,4,5);

--LIKE
Select *from students where S_NAME LIKE 'r%' ;

Select *from students where S_NAME LIKE '%li%';
